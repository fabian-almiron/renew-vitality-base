              ...
              <?php if( have_rows('flexible_content') ): ?>
                <?php while( have_rows('flexible_content') ): the_row(); ?>
                  ...
                  <?php if( get_row_layout() == 'header_section' ): ?>
                    ...
                    <div class="header-section full_width" style="background-image: url('<?php the_sub_field('header_image');?>'); height:<?php the_sub_field('header_height');?>px;">
                      <div class="wrapper">
                        <?php the_sub_field('header_text');?>
                      </div>
                    </div>
                    <div class="form-section full_width">
                      <div class="container">
